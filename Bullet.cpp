...
Bullet::Bullet()
	...
	imageSize_x(BULLET_IMAGE_WIDTH),imageSize_y(BULLET_IMAGE_HEIGHT),isFired_(false)
{
...
void Bullet::Draw()
{
	...
	if (isFired_)
	{
		DrawExtendGraphF(x_, y_, x_ + imageSize_x, y_ + imageSize_y, hBulletImage_, TRUE);	//弾の描画
	}
}
